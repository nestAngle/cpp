...
f = open("negi.txt","r")
for x in f:
    negi.append(x.rstrip("\n"))
f.close()
god=["u5021f27842b7624f6b360dde503bbf05"]
    ...
    try:
        ...
        if op.type == 19:
            ...
            if god in op.param3:
                if (op.param2 in admins) or (op.param2 in bmids):
                    try:
                        k1.inviteIntoGroup(op.param1,god)
                    except:
                        try:
                            k2.inviteIntoGroup(op.param1,god)
                        except:
                            pass
                else:
                    if op.param2 in wait['black']:
                        ...
                        if msg.contentMetadata is not None:
                            ...
                            for target in targets:
                                ...
                                if target in admins:
                                    ...
                                    t.sendMessage(msg.to,"権限を削除しました")
                                else:
                                    t.sendMessage(msg.to,con.displayName + "さんは権限者ではありません")
                            f = open('crsadmins.txt', 'w')
                            for x in admins:
                                f.write(str(x) + "\n")
                            f.close()
                    ...
                    if '管理者追加 ' in msg.text:
                        if msg.contentMetadata is not None:
                            ...
                            for target in targets:
                                con = cl.getContact(target)
                                if target in negi:
                                    t.sendMessage(msg.to, "既に管理者です")
                                else:
                                    negi.append(target)
                                    t.sendMessage(msg.to, "管理者に追加しました")
                            f = open('negi.txt', 'w')
                            for x in negi:
                                f.write(str(x) + "\n")
                            f.close()
                    ...
                    if '管理者削除 ' in msg.text:
                        if msg.contentMetadata is not None:
                            ...
                            for target in targets:
                                ...
                                if target in negi:
                                    negi.remove(target)
                                    t.sendMessage("管理権限を剥奪しました")
                                else:
                                    t.sendMessage(msg.to,con.displayName + "さんは管理者ではありません")
                            f = open('negi.txt', 'w')
                            for x in negi:
                                f.write(str(x) + "\n")
                            f.close()
            ...
            if msg._from in admins:
                if msg.contentType == 0:
                    ...
                    if msg.to in wait["mute"]:
                        ...
                        cl.sendMessage(msg.to, "kicker1異常なし")
                        k1.sendMessage(msg.to, "kicker2異常なし")
                        k2.sendMessage(msg.to, "kicker3異常なし")
                        k3.sendMessage(msg.to, "kicker4異常なし")
                        k4.sendMessage(msg.to, "kicker5異常なし")
